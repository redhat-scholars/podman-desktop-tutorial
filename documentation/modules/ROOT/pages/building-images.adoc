...
TIP: Feel free to down if you'd just like to xref:building-images.adoc#pulling.adoc[pull the container images], without downloading the application source code.
